    ...
    <div className="blog-container">
      <div className="blog-publication">
        <div className="blog-header">
          <img
            src={`https://ui-avatars.com/api/?name=${publicationDetails.course}&background=00FFC6&color=333`}
            alt="Avatar"
            ...
            {publicationDetails.comments.map((comment) => (
              <li key={comment._id} className="blog-comment">
                <div className="blog-comment-header">
                  <img
                    src={`https://ui-avatars.com/api/?name=${comment.userName}&background=07be94&color=333`}
                    alt="Avatar"
